...
// PostgresUpgradeSpec defines the desired state of PostgresUpgrade
type PostgresUpgradeSpec struct {
	...
	// foo is an example field of PostgresUpgrade. Edit postgresupgrade_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// PostgresUpgradeStatus defines the observed state of PostgresUpgrade.
type PostgresUpgradeStatus struct {
	...
	// conditions represent the current state of the PostgresUpgrade resource.
