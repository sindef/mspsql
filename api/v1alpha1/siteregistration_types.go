...
// SiteRegistrationSpec defines the desired state of SiteRegistration
type SiteRegistrationSpec struct {
	...
	// foo is an example field of SiteRegistration. Edit siteregistration_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// SiteRegistrationStatus defines the observed state of SiteRegistration.
type SiteRegistrationStatus struct {
	...
	// conditions represent the current state of the SiteRegistration resource.
